...
public class MaxNodeDaisyLearn extends MinMaxNodeDaisyLearn {
     ...
     */
    MaxNodeDaisyLearn(Board board, int depth, double alpha, double beta) {
     ...
     */
    @Override
    protected MinMaxNodeDaisyLearn getNextNode(Board board, int depth, double alpha, double beta) {
        return new MinNodeDaisyLearn(board, depth, alpha, beta);
    }
