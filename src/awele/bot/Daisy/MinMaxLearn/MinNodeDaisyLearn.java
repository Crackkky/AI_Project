...
public class MinNodeDaisyLearn extends MinMaxNodeDaisyLearn
{
     ...
     */
    MinNodeDaisyLearn(Board board, int depth, double alpha, double beta)
    {
    ...
    {
        return new MaxNodeDaisyLearn(board, depth, alpha, beta);
    }
